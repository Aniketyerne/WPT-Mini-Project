...
function CourseEligibility() {
  return (
    <>
      <div class="container">
        <div className="row">
          <div className="col-md-12 text-center">
            <h3 className="animate-charcter" style={{ marginTop: "50px" }}>
              {" "}
              C-DAC's PG Diploma Courses Eligibility Criteria.
              <br />
              CATEGORY 1(SECTION A in C-CAT)
            </h3>
          </div>
        </div>
      </div>
      <div style={{ textAlign: "start" }} className="container">
        ...
        <p>
          * Graduate in Engineering(10+2+4 or 10+3+3 years) in IT/Computer
          Science/Electronics/Telecom/Electrical
          <br />
          Instrumentation,OR
        </p>
        <p>
      ...
      <div className="container">
        <div className="row">
          <div className="col-md-12 text-center">
            <h3 className="animate-charcter" style={{ marginTop: "0px" }}>
              CATEGORY 2 (Section A +B in C-CAT)
            </h3>
          </div>
        </div>
      </div>
      <div style={{ textAlign: "start" }} className="container">
        ...
        <h3>Eligibility:</h3>
        <p>
          * Graduate Engineering (10+2+4 or 10+3+3 years)in IT / Computer
      ...
      <div style={{ textAlign: "start" }} className="container">
        ...
        <p>
          * Post graduate Degree in Management with Corresponnding Bachelor
          Degree in Computer Science,IT,Computer Applications OR
        </p>
        <p>
          * Post Graduate Degree in Physics / Mathematics / Statistics,OR
          <br />
      ...
      <div style={{ textAlign: "start" }} className="container">
        <h2>
          PG-DITISS-Post Graduate Diploma in IT Infrastructure,Systems &
          Security (min 55%)
        </h2>
        <h3>Eligibility:</h3>
        <p>
      ...
      <div style={{ textAlign: "start" }} className="container">
        <h2>
          PG-DHPCSA-Post Graduate Diploma in HPC Systems administration (min
          55%)
        </h2>
        <h3>Eligibility:</h3>
        <p>
      ...
      <div style={{ textAlign: "start" }} className="container">
        <h2>
          PG-DFBD-Post Graduate Diploma in FinTech and BlockChain Development
          (min 60%)
        </h2>
        <h3>Eligibility:</h3>
        <p>
        ...
        <p>
          MCA / MCM or Post Graduate degree in Mathematics / statistics /
          Physics
        </p>
        <p>
          * The canddates must have minimum 60% marks in there qualifying
      ...
      <div style={{ textAlign: "start" }} className="container">
        <h2>
          PG-DCSF-Post Graduate Diploma Cylinder Security and forensics (min
          60%)
        </h2>
        <h3>Eligibility:</h3>
        <p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <h3 class="animate-charcter" style={{ marginTop: "0px" }}>
              CATEGORY 3 (Section A+B+C in C-CAT)
            </h3>
          </div>
        </div>
      </div>
      ...
      <div style={{ textAlign: "start" }} className="container">
        <h2>
          There is no age restrictions for admissions in C-DAC's PG Diploma
          courses
          <br />
          Candidates who have appeared for final examminations of their
          qualifying
          <br />
          degree for admissions to the above courses.By qualifyingin C-DAC's
          <br />
          admissions tests , such candisates can apply for provisional admission
          in upcoming batch, subject to the conditions that:
          <br />
          <br />
          <br />
          Note: Candidates are required to ensure that they meet the eligibility
          criteria <br />
          of the courses for which they are applying. In case any candidate is
          focused to be
          <br />
          non -eligible during any stage of the admission process or course
          delivery
          <br />
          his/her admission will be cancelled with immidiate effect.
        </h2>
      </div>
    </>
  );
