...
function MyRegistration() {
  ...
  return (
    <>
      <div className="row d-flex align-items-center vh-100 justify-content-center bg-primary-subtle">
        <div className="col-sm-12 col-md-4">
          <div className="fs-2 mb-3" style={{textAlign: "center", fontFamily: "monospace"}}>Registration</div>
